  ...
  _createClass(_MyAccountCreateAccountContainer, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(fields) {
        var _this$props2, createAccount, onSignIn, setSignInState, setLoadingState, isLoading, password, email, firstname, lastname, is_subscribed, customerData, code;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(fields);
                password = fields.password, email = fields.email, firstname = fields.firstname, lastname = fields.lastname, is_subscribed = fields.is_subscribed;
                customerData = {
                  customer: {
                    firstname: firstname,
                    lastname: lastname,
...
//# sourceMappingURL=account.cd6938efddc6c60dcb25.hot-update.js.map