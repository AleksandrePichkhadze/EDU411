  ...
  _createClass(_Slider, [{
    ...
    value: function componentDidMount() {
      ...
      sliderChildren[0].onload = function () {
        _app_design_frontend_Scandiweb_pwa_src_app_util_CSS__WEBPACK_IMPORTED_MODULE_5__["default"].setVariable(sliderRef, 'slider-height', sliderHeight);
      };
    ...
    value: function setStyleVariablesOnMount() {
      ...
      if (isHeightTransitionDisabledOnMount) {
        ...
        _app_design_frontend_Scandiweb_pwa_src_app_util_CSS__WEBPACK_IMPORTED_MODULE_5__["default"].setVariable(sliderRef, 'height-transition-speed', transitionSpeed);
      }
    ...
    value: function setTranlateXStyle(translate) {
      ...
      _app_design_frontend_Scandiweb_pwa_src_app_util_CSS__WEBPACK_IMPORTED_MODULE_5__["default"].setVariable(this.draggableRef, isVertical ? 'translateY' : 'translateX', "".concat(translate, "px"));
    }
  }, {
