...
function (_Extensible) {
  ...
  _createClass(_ReviewQuery, [{
    ...
    value: function getAddProductReviewMutation(reviewItem) {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('createProductReview').setAlias('addProductReview').addArgument('input', 'CreateProductReviewInput!', reviewItem).addField(new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('review').addField('nickname'));
    }
  }, {
    key: "getRatingQuery",
    value: function getRatingQuery() {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('productReviewRatingsMetadata').setAlias('reviewRatings').addFieldList(this._getRatingFields());
    }
  }, {
    ...
    value: function _getRatingItemsField() {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('items').addFieldList(this._getRatingItemsFields());
    }
  }, {
    key: "_getRatingItemsFields",
    value: function _getRatingItemsFields() {
      return [new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('id').setAlias('rating_id'), new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('name').setAlias('rating_code'), this._getRatingOptionsField()];
    }
  }, {
    key: "_getRatingOptionFields",
    value: function _getRatingOptionFields() {
      return [new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('value_id').setAlias('option_id'), 'value'];
    }
  }, {
    key: "_getRatingOptionsField",
    value: function _getRatingOptionsField() {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_0__["Field"]('values').setAlias('rating_options').addFieldList(this._getRatingOptionFields());
    }
  }]);
...
function (_Extensible) {
  ...
  _createClass(_WishlistQuery, [{
    ...
    value: function getWishlistQuery(sharingCode) {
      var field = new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_wishlist').setAlias('wishlist').addFieldList(this._getWishlistFields());
    ...
    value: function getSaveWishlistItemMutation(wishlistItem) {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_saveWishlistItem').setAlias('saveWishlistItem').addArgument('wishlistItem', 'WishlistItemInput!', wishlistItem).addFieldList(this._getItemsFields());
    }
  }, {
    key: "getShareWishlistMutation",
    value: function getShareWishlistMutation(input) {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_shareWishlist').setAlias('shareWishlist').addArgument('input', 'ShareWishlistInput!', input);
    }
  }, {
    key: "getClearWishlist",
    value: function getClearWishlist() {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_clearWishlist').setAlias('clearWishlist');
    }
  }, {
    key: "getMoveWishlistToCart",
    value: function getMoveWishlistToCart(sharingCode) {
      var field = new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_moveWishlistToCart').setAlias('moveWishlistToCart');
    ...
    value: function getRemoveProductFromWishlistMutation(item_id) {
      return new _app_design_frontend_Scandiweb_pwa_src_app_util_Query__WEBPACK_IMPORTED_MODULE_4__["Field"]('s_removeProductFromWishlist').setAlias('removeProductFromWishlist').addArgument('itemId', 'ID!', item_id);
    }
  }, {
...
function (_Extensible) {
  ...
  _createClass(_ReviewDispatcher, [{
    ...
    value: function submitProductReview(dispatch, options) {
      return Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Request__WEBPACK_IMPORTED_MODULE_2__["fetchMutation"])(_app_design_frontend_Scandiweb_pwa_src_app_query_Review_query__WEBPACK_IMPORTED_MODULE_0__["default"].getAddProductReviewMutation(this.prepareReviewData(options))).then(
