...
function (_PureComponent) {
  _inherits(CategoryTypes, _PureComponent);

  function CategoryTypes() {
    _classCallCheck(this, CategoryTypes);

    return _possibleConstructorReturn(this, _getPrototypeOf(CategoryTypes).apply(this, arguments));
  }

  _createClass(CategoryTypes, [{
...
//# sourceMappingURL=category.f9e4b975f933cf9f816a.hot-update.js.map