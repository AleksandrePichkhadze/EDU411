<?php
namespace Scandiweb\Slider\Model\ResourceModel\Map\Collection;

/**
 * Interceptor class for @see \Scandiweb\Slider\Model\ResourceModel\Map\Collection
 */
class Interceptor extends \Scandiweb\Slider\Model\ResourceModel\Map\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addIsActiveFilter($active = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIsActiveFilter', func_get_args(), $pluginInfo) : parent::addIsActiveFilter($active);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSlideFilter');
        return $pluginInfo ? $this->___callPlugins('addSlideFilter', func_get_args(), $pluginInfo) : parent::addSlideFilter($slideId);
    }
