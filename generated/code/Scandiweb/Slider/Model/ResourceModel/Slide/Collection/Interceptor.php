<?php
namespace Scandiweb\Slider\Model\ResourceModel\Slide\Collection;

/**
 * Interceptor class for @see \Scandiweb\Slider\Model\ResourceModel\Slide\Collection
 */
class Interceptor extends \Scandiweb\Slider\Model\ResourceModel\Slide\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $localeDate, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($storeManager, $localeDate, $entityFactory, $logger, $fetchStrategy, $eventManager, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSliderFilter');
        return $pluginInfo ? $this->___callPlugins('addSliderFilter', func_get_args(), $pluginInfo) : parent::addSliderFilter($sliderId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDateFilter');
        return $pluginInfo ? $this->___callPlugins('addDateFilter', func_get_args(), $pluginInfo) : parent::addDateFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPositionOrder');
        return $pluginInfo ? $this->___callPlugins('addPositionOrder', func_get_args(), $pluginInfo) : parent::addPositionOrder();
    }
