<?php
namespace ScandiPWA\MenuOrganizer\Model\ResourceModel\Item\Collection;

/**
 * Interceptor class for @see \ScandiPWA\MenuOrganizer\Model\ResourceModel\Item\Collection
 */
class Interceptor extends \ScandiPWA\MenuOrganizer\Model\ResourceModel\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinParentNames');
        return $pluginInfo ? $this->___callPlugins('joinParentNames', func_get_args(), $pluginInfo) : parent::joinParentNames();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addMenuFilter');
        return $pluginInfo ? $this->___callPlugins('addMenuFilter', func_get_args(), $pluginInfo) : parent::addMenuFilter($menu);
    }
    ...
    public function addStatusFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStatusFilter', func_get_args(), $pluginInfo) : parent::addStatusFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setParentIdOrder');
        return $pluginInfo ? $this->___callPlugins('setParentIdOrder', func_get_args(), $pluginInfo) : parent::setParentIdOrder();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'excludeCurrentItem');
        return $pluginInfo ? $this->___callPlugins('excludeCurrentItem', func_get_args(), $pluginInfo) : parent::excludeCurrentItem($itemId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'toItemOptionArray');
        return $pluginInfo ? $this->___callPlugins('toItemOptionArray', func_get_args(), $pluginInfo) : parent::toItemOptionArray();
    }
